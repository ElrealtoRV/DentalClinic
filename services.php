...
<div class="sidebar">
  ...
  <ul>
        ...
        <li><a href="services.php" style="color:  #16a085; text-decoration: none;"><i class="fa fa-briefcase"></i> Services</a></li>
    ...
    <tbody>
      ...
      if ($result) {
        while ($row = mysqli_fetch_assoc($result)) {
          ...
          echo "<td>";
          echo "<a href='edit_service.php?id=" . $row['id'] . "' class='edit-btn'>Edit</a>";
          echo "<a href='services.php?delete_id=" . $row['id'] . "' class='delete-btn'>Delete</a>";
          echo "</td>";
          echo "</tr>";
        }
