...
<div class="sidebar">
  ...
  <ul>
        ...
        <li><a href="invoices.php" style="color:  #16a085; text-decoration: none;"><i class="fa fa-file-text"></i> Invoices</a></li>
...
<div class="content">
    <div class="form-container">
        <h1>Invoice for  Patient</h1>

        <form action="your_save_to_db_script.php" method="POST">
            <div class="form-group">
                <label for="patient" class="form-label">Patient To Create Receipt :</label>
    ...
    <table>
        <thead>
            <tr>
                ...
                <th>Total Amount</th>
                <th>Status</th>
                <th>Services</th> <!-- Existing Services column header -->
                <th>Prescription</th> <!-- Added Products column header -->
                <th>Action</th>
        ...
        <tbody>
            ...
            $sql = "SELECT i.id, i.patient_id, i.date, i.due_date, i.total_amount, i.status, i.service, i.`prescription`, p.fullname FROM invoices i
