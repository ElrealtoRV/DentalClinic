...
<div class="sidebar">
    ...
    <ul>
        ...
        <li><a href="Supplies.php" style="color: 16a085; text-decoration: none;"><i class="fa fa-user"></i> Supplies</a></li>
    ...
    <table border="1">
        <thead>
            <tr>
                ...
                <th>Product Name</th>
                <th>Category</th>
                <th>Price</th> <!-- Added Price column header -->
                <th>Action</th>
            </tr>
        </thead>
        <tbody>
            ...
            $sql = "SELECT ProductID, Products, Category, Price FROM supply";
