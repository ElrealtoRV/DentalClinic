<?php
include 'sad/db.php'; // Ensure this points to your actual database connection script
...
if (isset($_POST['update'])) {
    ...
    if ($stmt->affected_rows > 0) {
        ...
        header('Location: adminpatients.php'); // Adjust this to your patients list page
        exit();
    } else {
